...
public class BLUE_9_Gate extends BaseAutonomous {
    ...
    @Override protected Pose getShootingPose() { return new Pose(-40, -40, Math.toRadians(45)); }
    ...
    @Override protected Pose getPos2Forward()  { return new Pose(-70, 15, Math.toRadians(90)); }
